        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="hs-accordion-group" data-hs-accordion-always-open>
                    ...
                    <div className="flex items-center w-3/5 gap-x-9 text-[#9ca3af] ps-4">
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-1"
                          defaultChecked={
                            data.TypeOfLossDamage === "selected" ? true : false
                          }
                        />
                        <label
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-2"
                          defaultChecked={
                            data.TypeOfLossTheft === "selected" ? true : false
                          }
                        />
                        <label
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-3"
                          defaultChecked={
                            data.TypeOfLossThirdParty === "selected"
                              ? true
                              : false
                          }
                        />
                    ...
                    <div className="flex items-center w-3/5 gap-x-9 text-[#9ca3af] ps-4">
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-4"
                          defaultChecked={
                            data.IsDriverOwner === "selected" ? true : false
                          }
                        />
                        <label
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-5"
                          defaultChecked={
                            data.IsDriverPaidDriver === "selected"
                              ? true
                              : false
                          }
                        />
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-6"
                          defaultChecked={
                            data.IsDriverRelativeFriend === "selected"
                              ? true
                              : false
                          }
                        />
            ...
            >
              ...
              >
                <div className="py-3 mt-4 rounded-lg border-2 border-dashed border-[#c0c2c8] bg-[#e8f4fd]">
                    ...
                    <div className="flex items-center w-3/5 gap-x-9 text-[#9ca3af] ps-4">
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-7"
                          defaultChecked={
                            data.PoliceReportLodgedYes === "selected"
                              ? true
                              : false
                          }
                        />
                      ...
                      <div className="flex cursor-pointer">
                        <input
                          ...
                          id="hs-radio-group-8"
                          defaultChecked={
                            data.PoliceReportLodgedNo === "selected"
                              ? true
                              : false
                          }
                        />
                  ...
                  <div className="flex m-5 font-medium space-x-3">
                    <div className="flex items-center w-3/5 gap-x-9 text-[#9ca3af] ps-4">
                      Death/Injury to any occupant/Third Party (others) and/or
              ...
              >
                <div className="py-3 mt-4 z-10 rounded-lg border-2 border-dashed border-[#c0c2c8] bg-[#e8f4fd]">
                  <div className="text-justify mx-5 mt-5 mb-14 text-[#6B6B71]">
                    I/We the above named, do hereby, to the best of my/our
                    knowledge and belief, warrant the truth of the foregoing
                    statement in every respect and I/We agree that if I/We have
                    made or in any further declaration the company may require
                    in respect of the said accident, shall make any false or
                    fraudulent statement or any suppression or concealment the
                    policy shall be void and all right to recover there-under in
                    respect of past or future accidents shall be forfeited. I
                    understand that the company reserves the right of
                    verification of facts and documents relating to policy and
                    the claim.
                  </div>
                  <div className="flex m-5 font-medium space-x-3">
                    <div className="relative flex items-center w-2/4 border-2 border-[#D8E3E9] text-sm rounded-sm">
                    ...
                    >
                      ...
                      <button className="px-6 py-1 rounded-md text-white bg-[#347df6] text-sm">
                        Browse
                      </button>
                    </label>
                  </div>
                ...
                <div className="py-3 mt-4 z-10 rounded-lg border-2 border-dashed border-[#c0c2c8] bg-[#e8f4fd]">
                  <div className="flex m-5 font-medium space-x-3">
                    <div className="flex items-center w-full text-[#6B6B71] ">
                      N.B Please attach a photocopy of your blank / cancelled
                      cheque for NEFT purpose.
                    </div>
                    <input
                      type="file"
                      disabled
            ...
            <div className="flex justify-end space-x-4 mt-5 text-sm">
              <button
                type="submit"
                className="px-8 py-2 rounded-md bg-[#347df6] text-white"
              >
                Save
              </button>
              <button className="px-8 py-2 rounded-md bg-[#c1cee2] text-blue-700">
                Cancel
              </button>
            </div>
          </div>
